...
public class WriteExcelFileExample {
    private static final String FILE_PATH = "C:\\Users\\asd\\IdeaProjects\\SightCorpParserAtOnce\\src\\testWriteStudents.xlsx";
    ...
    public static void main(String args[]){
        ...
        Student student = new Student("Magneto","90","100","80");

        // Using XSSF for xlsx format, for xls use HSSF
        /***
         * This line is important for XLSX
         */
